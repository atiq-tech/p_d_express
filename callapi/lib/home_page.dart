...
import 'package:callapi/gif_item.dart';
...
class _Home_PageState extends State<Home_Page> {
  ...
  Future fetchData() async {
    try {
      ...
      showInToast("Something wrong bro");
  ...
  Widget build(BuildContext context) {
    ...
    return ModalProgressHUD(
      ...
      opacity: 0.5,
      child: Scaffold(
        backgroundColor: Color.fromARGB(255, 173, 236, 231),
        appBar: AppBar(
          backgroundColor: Color.fromARGB(255, 252, 189, 231),
          centerTitle: true,
          title: Text(
            "My First Api App",
            style: TextStyle(
