class ByCategorywiseSalesDetails {
  List<CategoryWiseSaleDetails>? _sales;
  String? _branch;

  ByCategorywiseSalesDetails({List<CategoryWiseSaleDetails>? sales, String? branch}) {
    if (sales != null) {
      this._sales = sales;
    }
    if (branch != null) {
  ...
  List<CategoryWiseSaleDetails>? get sales => _sales;
  set sales(List<CategoryWiseSaleDetails>? sales) => _sales = sales;
  String? get branch => _branch;
  set branch(String? branch) => _branch = branch;

  ByCategorywiseSalesDetails.fromJson(Map<String, dynamic> json) {
    if (json['sales'] != null) {
      _sales = <CategoryWiseSaleDetails>[];
      json['sales'].forEach((v) {
        _sales!.add(new CategoryWiseSaleDetails.fromJson(v));
      });
    }
    _branch = json['branch'];
  }
...
class CategoryWiseSaleDetails {
  ...
  CategoryWiseSaleDetails.fromJson(Map<String, dynamic> json) {
